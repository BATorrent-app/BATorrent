...
QtObject {
    ...
    readonly property var sections: [
        ...
        [
            ...
            { type: "toggle", key: "startWithSystem", label: (i18n.language, i18n.t("set_start_with_system")), note: (i18n.language, i18n.t("set_start_with_system_note")) },
            { type: "toggle", key: "startTray", label: (i18n.language, i18n.t("settings_start_tray")), note: (i18n.language, i18n.t("settings_start_tray_note")) },
