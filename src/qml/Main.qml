...
Window {
    ...
    ContextMenu {
        ...
        onRemoveRequested: removeDlg.open()
        onMoveStorageRequested: setLocationDlg.open()
        onExportRequested: exportTorrentDlg.open()
        onDiagnoseRequested: { diagnoseDlg.body = session.diagnoseSelectedSlow(); diagnoseDlg.open() }
    }
